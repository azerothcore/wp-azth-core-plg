    ...
    public function getRender() {
        ...
        <form name="form-acore-settings" method="post" action="">
            ...
            <p>Database Characters Host: 
                <input type="text" name="acore_db_chars_host" value="<?= sOpts()->acore_db_chars_host; ?>" size="20">
            </p>
            <p>Database Characters User: 
                <input type="text" name="acore_db_chars_user" value="<?= sOpts()->acore_db_chars_user; ?>" size="20" >
            </p>
            <p>Database Characters Pass: 
                <input type="text" name="acore_db_chars_pass" value="<?= sOpts()->acore_db_chars_pass; ?>" size="20" >
            </p>
            <p>Database Characters Name: 
                <input type="text" name="acore_db_chars_name" value="<?= sOpts()->acore_db_chars_name; ?>" size="20" >
            </p>
